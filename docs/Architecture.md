...
| 비동기 - Kafka | Kafka Event | 서비스 간 비동기 | 재고 동기화, 구매확정→정산, 배송완료→리뷰 등 |
...
- Review Service: ReviewCreatedEvent, ReviewUpdatedEvent, ReviewDeletedEvent
- Member Service: MemberRegisteredEvent, SellerApprovedEvent
